...
<head>
    ...
    <!-- Theme CSS -->
    <link href="{{ mix('css/theme.css', 'assets') }}" rel="stylesheet" id="stylesheetLight">
    <link href="{{ mix('css/theme-dark.css', 'assets') }}" rel="stylesheet" id="stylesheetDark">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebarCollapse">
            ...
            <ul class="navbar-nav mb-md-4">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="#">
                        <i class="fe fe-git-branch"></i> Changelog <span class="badge badge-primary ml-auto">v1.0</span>
                    </a>
                </li>
            </ul>
